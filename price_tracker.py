...
Info  : https://brightdata.de/products/insights/price-tracker/yahoo-auctions
"""
...
# https://brightdata.de/products/web-scraper/yahoo-auctions
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Yahoo! Auctions Japan scraper at: https://brightdata.de/products/web-scraper/yahoo-auctions\n"
